...
const planoSchema = {
  ...
  properties: {
    ...
    kcal_diaria_meta: { type: 'number', exclusiveMinimum: 0 },
    metas_macros_diarias: {
      ...
      properties: {
        ...
        gorduras: { type: 'number', minimum: 0 },
        carboidratos: { type: 'number', minimum: 0 },
      },
    },
    dias: {
      ...
      items: {
        ...
        properties: {
          ...
          meta_kcal: { type: 'number', exclusiveMinimum: 0 },
          kcal_planejadas: { type: 'number', minimum: 0 },
          ...
          refeicoes: {
            ...
            items: {
              ...
              properties: {
                ...
                kcal_total: { type: 'number', minimum: 0, maximum: 950 },
                carb_total: { type: 'number', minimum: 0 },
                prot_total: { type: 'number', minimum: 0 },
                gord_total: { type: 'number', minimum: 0 },
      ...
      try {
        const response = await fetch('https://api.openai.com/v1/responses', {
          ...
          headers: {
            ...
            'X-Client-Request-Id': `${requisicaoId}-${FUNCTION_VERSION}`,
          },
